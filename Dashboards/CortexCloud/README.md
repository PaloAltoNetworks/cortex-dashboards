...
| [CNAPP - Posture Issues Dashboard](images_onboarding_status/) | CNAPP posture issues with detailed breakdowns by severity, status, category, and asset context                                                          |  No | Oleg Kostine | :uk: |
| [CNAPP - Cloud Health Ingestion/Scan Status Dashboard](images_onboarding_status/) | Cloud Health ingestion/scans auditing errors across providers, assets, regions, and error messages                                                                                                  |  No | Oleg Kostine | :uk: |
...
## Drilldown URL
 ...
 > [!NOTE]
> When importing dashboards with URL drilldowns that reference your tenant, in order for the drilldowns to work, it is required to search/replace
